    ...
    aiSkill: {
      ...
      workflowPreflight: {
        ...
        editable: {
          ...
          capabilityEvidence: {
            manifestSchema: { path: "/resolved/image-to-editable-pptx/src/contracts.ts", sha256: "6".repeat(64) },
            officialDonor: { path: "/resolved/image-to-editable-pptx/src/pipeline.ts", sha256: "7".repeat(64) },
            objectNames: { path: "/resolved/image-to-editable-pptx/src/export/pptx.ts", sha256: "8".repeat(64) },
          },
        },
