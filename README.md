...
当前设计系统包含立体、玻璃、水墨、经典手绘、教材图解、创意拼贴、电影科技、奢华摄影、建筑蓝图、叙事幻想共 10 种风格。立体、玻璃、水墨保留 1／2／3 档创意及偏冷／基准中线／偏暖配色；其余七种目前只提供已接受的 3 档／基准中线组合，共 34 个可选组合。
方案发布时生成任务内的完整方案确认页：先核对整体叙事、事实／偏好／假设和逐页完整文案，再看 10 张代表展示图及所选风格的全部现有档位与配色。选择组合后可查看当前版本的确切样页出站 prompt、参考用途、输出位置和新增 1 次调用预算；页面意见与选择只形成草稿，复制并发送当前版本的明确授权后才会创建样页任务。技能包只包含在线图片索引，31 张精确组合预览和 10 张代表图均从 imgtg 加载；缺少立体 1 档中线、玻璃 1 档偏冷、玻璃 2 档偏冷时会明确说明，组合仍可选择且不会自动补生图。
